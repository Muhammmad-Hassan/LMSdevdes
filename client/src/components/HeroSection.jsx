    ...
    <>
      <div className="flex flex-col -reverse md:flex-row-reverse justify-between items-center h-screen p-6 md:p-16 bg-gradient-to-br from-white to-cyan-100 text-gray-800">
        <div className="flex-1 md:max-w-[45%] text-left md:text-left ">
          <motion.h1 initial={{ x: 200, opacity: 0 }}  animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, type: "spring", stiffness: 50 }} className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 md:mb-5 leading-snug md:leading-tight transition-colors duration-300 ease-in-out">
